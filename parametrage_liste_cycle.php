                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href="parametrage_liste_cycle.php">Liste des cycles</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="box">
                            ...
                            <table id ="example" class="text-fade table table-bordered display" style="width: 100%;">
                                    <thead class="bg-primary">
                                        <tr>
                                            ...
                                            <th  class="text-center">Nom de cycle</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td  class="text-center">Premiers</td>
                                          ...
                                          <td class="table-action ">
                                                    <div class="d-flex justify-content-center align-items-center">
                                                        ...
                                                        <form action="">
                                                            <a href="parametrage_modifier_cycle.php"
                                        ...
                                        <tr>
                                            ...
                                            <td  class="text-center">Collége</td>
                                            <td class="table-action ">
                                                    <div class="d-flex justify-content-center align-items-center">
                                                        <form action="">
                ...
                <div class="row">
					<div class="col-lg-2 ms-auto">
						<a href="parametrage_ajouter_cycle.php">
