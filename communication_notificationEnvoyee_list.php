                        ...
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page"><a
                                        href="communication_mes_notification.php">Communication</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><a
                                        href="communication_notificationEnvoyee_list.php">Les notifications envoyées</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="table-responsive ">
                            <table id="example" class="mx-auto text-fade table table-bordered display">
