                            ...
                            <div class="row my-5">
                                <form action="" class="form">
                                    <div class="form-group my-10 ">
                                        <label class="form-label fs-15">Le professeur a le droit de contacter aux :</label>
                                    ...
                                    <div class="form-group my-10 ">
                                    <label class="form-label fs-15 ">Le parent a le droit de contacter aux : </label>
                                    ...
                                    <label class="form-label fs-15 ">L'élève a le droit de contacter aux : </label>
