                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href="ecole_parametrage_liste_cycle.php">Liste des cycles</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <section class="content">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="table-action text-center ">
                                                ...
                                                <a href="ecole_parametrage_modifier_cycle.php" class="text-fade text-primary me-2"><i
            ...
            <div class="row  ">
                <div class=" d-flex flex-row justify-content-end ">
                    <a href="ecole_parametrage_ajouter_cycle.php">
