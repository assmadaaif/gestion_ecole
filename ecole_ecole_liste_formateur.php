                        ...
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page"><a
                                        href="ecole_ecole_liste_formateur.php">Formateurs</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><a
                                        href="ecole_ecole_liste_formateur.php">Liste des formateurs</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="table-action ">
                                            ...
                                            <a href="ecole_ecole_modifier_formateur.php"
