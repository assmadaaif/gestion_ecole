                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page"><a href="parametrage_liste_serie.php">Séries</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><a href="parametrage_liste_serie.php">Liste des Sséries</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="box">
                            ...
                            <table  id ="example" class="text-fade table table-bordered display" style="width: 100%;">
                                    <thead class="bg-primary">
                                        <tr>
                                            ...
                                            <th  class="text-center">Nom de Série</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="table-action ">
                                                    <div class="d-flex justify-content-center align-items-center">
                                                        ...
                                                        <form action="">
                                                            <a href="parametrage_modifier_serie.php"
                                        ...
                                        <tr>
                                            ...
                                            <td  class="text-center">Lettre</td>
                                            <td class="table-action ">
                                                    <div class="d-flex justify-content-center align-items-center">
                                                        <form action="">
                ...
                <div class="row">
					<div class="col-lg-2 ms-auto">
						<a href="parametrage_ajouter_serie.php">
