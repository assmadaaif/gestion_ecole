                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href="parametrage_liste_serie.php">Liste des Séries</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="table-action  text-center">
                                                ...
                                                <a href="parametrage_modifier_serie.php" class="text-fade text-primary "><i
