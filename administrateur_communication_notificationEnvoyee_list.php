                        ...
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page"><a
                                        href="administrateur_communication_mes_notification.php">Communication</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><a
                                        href="administrateur_communication_notificationEnvoyee_list.php">Liste des notifcations</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
