                ...
                <div class="col-lg-12 col-12">
                    <div class="box">
                        <div class="box-body">
                            <div class="px-4">
                                <div class="mt-30">
                                    <h5 class="fs-18">Traduire la notification</h5>
                                                            ...
                                                            <div class="w-p100  overflow-hidden">
                                                                ...
                                                                <p class="mt-1 mb-0 text-muted fs-14">
                                                                    ...
                                                                    <span class="w-75 text-muted mt-5">Lorem ipsum dolor
                                                                        sit
                                                                        amet
                                                                        consectetur adipisicing elit. Beatae tempora
                                                                        nisi,
                                                                        laudantium, quidem magnam ipsum ad ab iste est
                                                                        doloremque adipisci impedit ipsam deleniti
                                                                        labore hic
                                                                        cupiditate reprehenderit perspiciatis
                                                                        obcaecati.</span>
                                                                        <p class="mt-3 text-primary">Langue : Français</p>
