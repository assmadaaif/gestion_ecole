                ...
                <div class="me-auto">
                    ...
                    <div class="d-inline-block align-items-center">
                        ...
                        <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page"><a href="ecole_liste_parent.php">Parents</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><a href="ecole_modifier_parent.php">Modifier parent</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
