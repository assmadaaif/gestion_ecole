										...
										<div class="media-list media-list-hover">
											<a href="javascript:void(0);" class="media p-0">
												<div class="w-p100 d-flex align-items-center m-1 p-2">
													...
													<h5 class="mt-0 mb-0 fs-14 fw-600 ">
															<span class="float-end text-muted fs-12 fw-400">22h 30min 17s</span>
                                                            <span>Ahmed SAAD : <span class="text-success">Gérant</span></span>
															
															<p class="text-secondary">École : Iben Zohr</p>
															
                                                        </h5>

														<p class="mt-1 mb-0 text-muted fs-14">
															<span class="w-25 float-end text-end"><span class="badge badge-danger-light">3</span></span>
															<span class="w-75 text-dark">Lorem ipsum dolor sit amet.?</span>
														</p>
													</div>
												</div>
											</a>
											...
											<a href="javascript:void(0);" class="media p-0 bg-gray-300">
												<div class="w-p100 d-flex align-items-center m-1 p-2">
													...
													<h5 class="mt-0 mb-0 fs-14 fw-600 text-primary ">
															<span class="float-end text-muted fs-12 fw-400">Hier à 17h 30min 17s</span>
                                                            <span>Oumaima ASAAD : <span class="text-success">Foramateur</span></span>
															
															<p class="text-secondary">École : Idriss Benasser</p>
															
                                                        </h5>
														<p class="mt-1 mb-0 text-muted fs-14">
															<span class="w-75">Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis laboriosam quae unde reiciendis accusamus quia?....</span>
														</p>
													</div>
												</div>
											</a>
											...
											<a href="javascript:void(0);" class="media p-0">
												<div class="w-p100 d-flex align-items-center m-1 p-2">
													...
													<div class="w-p100 overflow-hidden">
													<h5 class="mt-0 mb-0 fs-14 fw-600 ">
															<span class="float-end text-muted fs-12 fw-400">Le Mardi 11 janvier 2022 à 12h 30min 17s</span>
                                                            <span>Amal MAJD : <span class="text-success">Gérant</span></span>
														...
														<p class="mt-1 mb-0 text-muted fs-14">
															...
															<span class="w-75 text-dark">Lorem ipsum dolor sit amet consectetur adipisicing elit....</span>
														</p>
													</div>
												</div>
											</a>
											<a href="javascript:void(0);" class="media p-0">
												<div class="w-p100 d-flex align-items-center m-1 p-2">
													...
													<div class="w-p100 overflow-hidden">
													<h5 class="mt-0 mb-0 fs-14 fw-600 ">
															<span class="float-end text-muted fs-12 fw-400">Le Jeudi 9 janvier 2022 à 23h 10min 17s</span>
                                                            <span>Ridouane BENMOUSA : <span class="text-success">Formateur</span></span>
															
															<p class="text-secondary">École : El Moutanabi</p>
											...
											<a href="javascript:void(0);" class="media p-0">
												<div class="w-p100 d-flex align-items-center m-1 p-2">
													...
													<h5 class="mt-0 mb-0 fs-14 fw-600 ">
															<span class="float-end text-muted fs-12 fw-400">Le Mardi 11 janvier 2022 à 12h 30min 17s</span>
                                                            <span>Mohamed KHALIDI : <span class="text-success">Formateur</span></span>
