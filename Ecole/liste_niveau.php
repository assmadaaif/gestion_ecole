                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">niveau</li>
                                <li class="breadcrumb-item active" aria-current="page">Liste des niveaux</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                    ...
                                    <tbody>
                                        ...
                                        <td>niveau 1</td>
                                            ...
                                            <td class="table-action ">
                                                ...
                                                <a href="modifier_niveau.php" class="text-fade text-primary me-2"><i
