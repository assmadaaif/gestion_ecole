                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">filiére</li>
                                <li class="breadcrumb-item active" aria-current="page">Ajouter filiére</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                            ...
                            <div class="box-body row ">
                                <div class="col-lg-6 ">
                                    <div class="form-group">
                                        <label class="form-label">Nom de Filière</label>
