                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Matières </li>
                                <li class="breadcrumb-item active" aria-current="page">Liste des Matière </li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                    ...
                                    <tbody>
                                        ...
                                        <td>matiere 1</td>
                                            ...
                                            <td class="table-action ">
                                                ...
                                                <a href="modifier_matiere.php" class="text-fade text-primary me-2"><i
