                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Liste des Séries</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                    ...
                                    <tbody>
                                        ...
                                        <td>serie 1</td>
                                            ...
                                            <td class="table-action ">
                                                ...
                                                <a href="modifier_serie.php" class="text-fade text-primary me-2"><i
