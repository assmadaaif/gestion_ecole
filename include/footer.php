<!-------------------------script ---------------->
	...
	<script src="../src/js/pages/form-compose.js"></script>
...
<script src="../assets/vendor_components/bootstrap-select/dist/js/bootstrap-select.js"></script>
    ...
    <script src="
    ../assets/vendor_components/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.js"></script>
...
<footer class="main-footer">
    <div class="pull-right d-none d-sm-inline-block">
	  ...
	  &copy; <script>document.write(new Date().getFullYear())</script> <a href="https://.com/"></a>. All Rights Reserved.
  </footer>   
  <!-- Side panel -->   
  <!-- quick_user_toggle -->
