            ...
            <div class="multinav-scroll" style="height: 97%;">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="eleve_ecole_liste_formateur.php"><i class="icon-Commit"><span
                                            class="path1"></span><span class="path2"></span></i>Formateurs </a></li>
                            <li><a href="eleve_ecole_liste_matiere.php"><i class="icon-Commit"><span
                                            class="path1"></span><span class="path2"></span></i>Matières </a></li>
                            <li><a href="eleve_ecole_liste_parent.php"><i class="icon-Commit"><span
