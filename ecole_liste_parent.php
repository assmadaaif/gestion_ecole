                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page"><a href="ecole_liste_parent.php">Parent</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><a href="ecole_liste_parent.php">Liste des parents</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <section class="content">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="table-action ">
                                            ...
                                            <a href="ecole_modifier_parent.php" class="text-fade text-primary "><i
            ...
            <div class="row  ">
                <div class=" d-flex flex-row justify-content-end ">
                    <a href="ecole_ajouter_parent.php">
