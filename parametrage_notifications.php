                        ...
                        <form class="form">
                            <div class="box-body row ">
                                    ...
                                    <div class="col-lg-12 form-group d-flex flex-row ">
                                        <label class="form-label col-lg-3">Le professeur à le droit de crée et d’envoyé aux : </label>
                                    ...
                                    <div class="col-lg-12 form-group d-flex flex-row ">
                                        <label class="form-label col-lg-3">Le parent à le droit de crée et d’envoyé aux : </label>
                                    ...
                                    <div class="col-lg-12 form-group d-flex flex-row ">
                                        <label class="form-label col-lg-3">L'élève à le droit de crée et d’envoyé aux : </label>
