						...
						<nav>
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item" aria-current="page"><a
										href="administration_liste_type_parent.php">Types parents</a></li>
			...
			<div class="box">
									...
									<tbody>
										...
										<tr>
											...
											<td class="table-action  d-flex  justify-content-center align-items-center">
												...
												<form action="">
													<a href="administration_modifier_type_parent.php"
				...
				<div class="row mb-5">
					<div class="col-lg-2 ms-auto ">
						<a href="administration_ajouter_type_parent.php ">
