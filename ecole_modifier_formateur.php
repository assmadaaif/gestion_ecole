                ...
                <div class="me-auto">
                    ...
                    <div class="d-inline-block align-items-center">
                        ...
                        <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page"><a href="ecole_liste_formateur.php">Formateurs</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><a href="ecole_modifier_formateur.php">Modifier un formateur</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
